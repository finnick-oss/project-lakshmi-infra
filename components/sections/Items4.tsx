											...
											<div className="items-content-area">
												...
												<div className="content-area">
													...
													<div className="btn-area">
														...
														<div className="btn-area">
															<Link href="#" className="heart"><img src="/assets/img/icons/heart5.svg" alt="housebox" className="heart1" />
																<img src="/assets/img/icons/heart5.svg" alt="housebox" className="heart2" /></Link>
