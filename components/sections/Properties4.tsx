						...
						<div className="col-lg-12">
							<div className="property-heading space-margin60">
								<div className="heading3">
									<h5 data-aos="fade-left" data-aos-duration={800}>our top property</h5>
											...
											<div className="row">
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															...
															<ul>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bed1.svg" alt="housebox" /></span> 12</Link></li>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bath1.svg" alt="housebox" /></span> 08</Link></li>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Amberwood
																Retreat</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Cedar Crest
																Residences</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
