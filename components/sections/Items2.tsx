									...
									<div className="col-lg-7">
										<div className="items-content-area">
											...
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="housebox" />x12
														Beds</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="housebox" />x16
														Baths</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="housebox" />1200
														sq</Link></li>
												</ul>
												...
												<div className="btn-area">
													...
													<div className="btn-area">
														<Link href="#" className="heart"><img src="/assets/img/icons/heart1.svg" alt="housebox" className="heart1" />
															<img src="/assets/img/icons/heart2.svg" alt="housebox" className="heart2" /></Link>
