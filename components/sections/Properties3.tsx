						...
						<div className="col-lg-12">
							<div className="property-heading heading2 space-margin60">
								...
								<div className="btn-area1" data-aos="zoom-in-up" data-aos-duration={1000}>
									<Link href="/sidebar-grid" className="theme-btn4">See All Properties <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
											...
											<div className="row">
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<ul className="category-list">
															...
															<li><Link href="/property-details-v1">For Rent</Link></li>
														</ul>
														<div className="content-area">
															...
															<ul>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bed1.svg" alt="housebox" /></span> 12 <span className="line"> |
																</span></Link></li>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bath1.svg" alt="housebox" /></span> 08 <span className="line"> |
																</span></Link></li>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/sqare1.svg" alt="housebox" /></span> 1200 SQ</Link></li>
															</ul>
															<div className="space24" />
															<div className="btn-area">
																...
																<div className="love-share">
																	<Link href="#" className="heart"><img src="/assets/img/icons/heart3.svg" alt="housebox" className="heart1" /> <img src="/assets/img/icons/heart4.svg" alt="housebox" className="heart2" /></Link>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">The Grand
																Horizon</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Lakeside Heights</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
															<ul>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">The Emerald Bay</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
															<ul>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Willow Creek
																Estates</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">The Skyline
																Haven</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
											...
											<div className="row">
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Sunset Ridge
																Villas</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">The Crystal
																Meadows</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Riverside Grove</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
															<ul>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">The Pinnacle
																Retreat</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															<Link href="/property-details-v1" className="head">Oakwood Manor</Link>
															<div className="space16" />
															<p>Los Angeles City, CA, USA</p>
															<div className="space24" />
															<ul>
