				...
				<div className="mobile-sidebar mobile-sidebar1">
					...
					<div className="mobile-nav mobile-nav1">
						<ul className="mobile-nav-list nav-list1">
							...
							<li><Link href="/features">Listing</Link>
								<span className={`submenu-button ${isAccordion == 2 ? "submenu-opened" : ""}`} onClick={() => handleAccordion(2)}><em></em></span>
							...
							<li><Link href="/features">Properties</Link>
								<span className={`submenu-button ${isAccordion == 3 ? "submenu-opened" : ""}`} onClick={() => handleAccordion(3)}><em></em></span>
							...
							<li><Link href="/#">Blogs</Link>
								<span className={`submenu-button ${isAccordion == 4 ? "submenu-opened" : ""}`} onClick={() => handleAccordion(4)}><em></em></span>
							...
							<li><Link href="/#">Pages</Link>
								<span className={`submenu-button ${isAccordion == 5 ? "submenu-opened" : ""}`} onClick={() => handleAccordion(5)}><em></em></span>
							...
							<li><Link href="/#">Dashboard</Link>
								<span className={`submenu-button ${isAccordion == 6 ? "submenu-opened" : ""}`} onClick={() => handleAccordion(6)}><em></em></span>
								<ul className="sub-menu" style={{ display: `${isAccordion == 6 ? "block" : "none"}` }}>
									...
									<li><Link href="/my-property">Add Property</Link></li>
								</ul>
							</li>
						</ul>
								...
								<div className="footer1-contact-info">
									...
									<div className="single-footer">
										...
										<div className="contact-info-single">
											...
											<div className="contact-info-text">
												<Link href="/mailto:info@example.com">55 East Birchwood Ave.Brooklyn, <br /> New York
													11201,United States</Link>
											</div>
										</div>
									</div>
									<div className="single-footer">
