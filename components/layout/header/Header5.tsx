							...
							<div className="col-lg-12">
								<div className="header-top-area">
									...
									<ul className="list-content">
										...
										<li><Link href="/#" className="signin"><span> | </span>Sign In</Link></li>
									</ul>
								</div>
								<div className="header-elements">
									...
									<div className="btn-area">
										...
										<button className="hamburger_menu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
