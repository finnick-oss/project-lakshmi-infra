							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/"><img src="/assets/img/logo/logo2.png" alt="housebox" /></Link>
									</div>
															...
															<div className="all-images-menu">
																<div className="images">
																	<div className="homemenu-thumb">
																		...
																		<div className="homemenu-btn">
																			<Link className="theme-btn3" href="/">View Demo
																...
																<div className="images">
																	<div className="homemenu-thumb">
																		...
																		<div className="homemenu-btn">
																			<Link className="theme-btn3" href="/index2"> View Demo
																				<span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																					<path d="M12 13H4V11H12V4L20 12L12 20V13Z">
																					</path>
																				</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																...
																<div className="images">
																	<div className="homemenu-thumb">
																		...
																		<div className="homemenu-btn">
																			<Link className="theme-btn3" href="/index3">View Demo
																				<span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																					<path d="M12 13H4V11H12V4L20 12L12 20V13Z">
																					</path>
																				</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																...
																<div className="images">
																	<div className="homemenu-thumb">
																		...
																		<div className="homemenu-btn">
																			<Link className="theme-btn3" href="/index4">View Demo
																				<span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																					<path d="M12 13H4V11H12V4L20 12L12 20V13Z">
																					</path>
																				</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
									...
									<div className="btn-area">
										...
										<Link href="/sidebar-grid" className="theme-btn3">View Listing <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
											<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
										</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
											<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
										</svg></span></Link>
