					...
					<div className="row">
						<div className="col-lg-3 col-md-6">
							<div className="footer-logoarea">
								<img src="/assets/img/logo/logo1.png" alt="laxmiinfra" />
								<div className="space24" />
								<p>As LaxmiInfra lead negotiator, Chris brings years of experience in securing the best deals
									both.</p>
								<div className="space24" />
								<ul>
						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-content2">
								...
								<div className="space4" />
								<ul>
									<li><Link href="/tel:#+919876543210"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
									...
									</svg> support@laxmiinfra.com</Link></li>
									<li><Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<div className="row">
						<div className="col-lg-12">
							<div className="copyright text-center">
								<p>©Copyright {new Date().getFullYear()} - LaxmiInfra. All Right Reserved</p>
							</div>
						</div>
					</div>
				</div>
