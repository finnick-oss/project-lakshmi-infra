			...
			<Layout headerStyle={1} footerStyle={1}>
				<div>
					<div className="hero-inner-section-area-sidebar">
						<img src="/assets/img/all-images/hero/hero-img1.png" alt="LaxmiInfra" className="hero-img1" />
							...
							<div className="row">
								<div className="col-lg-7">
									<div className="vission-mission-box">
										...
										<div className="space24" />
										<p>At LaxmiInfra, we’re redefining the way people find, sell, and invest in properties. Our
											mission is to simplify real a estate by provide innovative solutions, expert guidance.</p>
										<div className="space24" />
										<h4>Our Mission</h4>
										<div className="space16" />
										<p>To provide a reliable, transparent, and innovative real estate experience that exceeds
											expectations and fosters lasting relationships.</p>
										<div className="space24" />
										<h4>Our Vision</h4>
										<div className="space16" />
										<p>To be the leading platform for real estate solutions, empowering individuals and businesses
											to achieve their property goals with ease.</p>
										<div className="space32" />
								...
								<div className="col-lg-5">
									<div className="img1">
										<img src="/assets/img/all-images/properties/property-img47.png" alt="LaxmiInfra" />
									</div>
								</div>
							</div>
						</div>
									...
									<div className="about-images-area">
										<div className="row align-items-center">
											<div className="col-lg-6 col-md-6">
												<div className="img2 image-anime reveal">
													<img src="/assets/img/all-images/about/about-img3.png" alt="LaxmiInfra" />
												</div>
											</div>
											<div className="col-lg-6 col-md-6">
												<div className="img1 image-anime reveal">
													<img src="/assets/img/all-images/about/about-img4.png" alt="LaxmiInfra" />
												</div>
												<div className="space30" />
												<div className="img1 image-anime reveal">
													<img src="/assets/img/all-images/about/about-img5.png" alt="LaxmiInfra" />
												</div>
											</div>
										</div>
						...
						<div className="container">
							...
							<div className="row">
								<div className="col-lg-4">
									<div className="img1">
										<img src="/assets/img/all-images/about/about-img9.png" alt="LaxmiInfra" />
									</div>
								</div>
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>At LaxmiInfra, we know that buying a home is one life’s biggest milestones. Our
														experienced team is here to guide you through every step home.</p>
													<div className="space24" />
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Selling your home doesn’t have to be overwhelming. With LaxmiInfra, our dedicated
														experts will make process smooth, stress-free, and rewarding.</p>
													<div className="space24" />
													<Link href="/property-details-v1" className="readmore">learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
														<path d="M13.0508 12.361L7.39395 18.0179L5.97974 16.6037L11.6366 10.9468L6.68684 5.99707H18.0006V17.3108L13.0508 12.361Z">
														</path>
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Finding the right rental property is easy with LaxmiInfra. Whether you’re seeking a
														cozy apartment spacious home, we offer a variety of options.</p>
													<div className="space24" />
													<Link href="/property-details-v1" className="readmore">learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
														<path d="M13.0508 12.361L7.39395 18.0179L5.97974 16.6037L11.6366 10.9468L6.68684 5.99707H18.0006V17.3108L13.0508 12.361Z">
														</path>
										...
										<div className="col-lg-6 col-md-6">
											<div className="offer-boxarea">
												...
												<div className="content">
													...
													<div className="space16" />
													<p>Managing properties can be time-consuming, but LaxmiInfra makes it effortless. Our
														property management services ensure your investments.</p>
													<div className="space24" />
													<Link href="/property-details-v1" className="readmore">learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
														<path d="M13.0508 12.361L7.39395 18.0179L5.97974 16.6037L11.6366 10.9468L6.68684 5.99707H18.0006V17.3108L13.0508 12.361Z">
														</path>
							...
							<div className="row">
								<div className="col-lg-6 m-auto">
									<div className="team-header heading1 space-margin60 text-center">
										<h5 data-aos="fade-left" data-aos-duration={800}>Experts Behind LaxmiInfra</h5>
										<div className="space20" />
										<h2 className="text-anime-style-3">The LaxmiInfra Dream Team</h2>
									</div>
								</div>
							</div>
							<div className="row">
								<div className="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-duration={800}>
									<div className="team-widget-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/team/team-img1.png" alt="LaxmiInfra" />
											<div className="share">
								...
								<div className="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-duration={900}>
									<div className="team-widget-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/team/team-img2.png" alt="LaxmiInfra" />
											<div className="share">
												<Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" width={17} height={18} viewBox="0 0 17 18" fill="none">
													<path d="M14.1333 12.7229C13.4578 12.7229 12.8533 12.994 12.3911 13.4187L6.05332 9.66867C6.09777 9.46084 6.13332 9.25301 6.13332 9.03614C6.13332 8.81928 6.09777 8.61145 6.05332 8.40361L12.32 4.68976C12.8 5.14157 13.4311 5.42169 14.1333 5.42169C15.6089 5.42169 16.8 4.21084 16.8 2.71084C16.8 1.21084 15.6089 0 14.1333 0C12.6578 0 11.4667 1.21084 11.4667 2.71084C11.4667 2.92771 11.5022 3.13554 11.5467 3.34337L5.27999 7.05723C4.79999 6.60542 4.16888 6.3253 3.46665 6.3253C1.9911 6.3253 0.799988 7.53614 0.799988 9.03614C0.799988 10.5361 1.9911 11.747 3.46665 11.747C4.16888 11.747 4.79999 11.4669 5.27999 11.0151L11.6089 14.7741C11.5644 14.9639 11.5378 15.1627 11.5378 15.3614C11.5378 16.8163 12.7022 18 14.1333 18C15.5644 18 16.7289 16.8163 16.7289 15.3614C16.7289 13.9066 15.5644 12.7229 14.1333 12.7229Z" fill="white" />
												</svg></Link>
								...
								<div className="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-duration={1000}>
									<div className="team-widget-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/team/team-img3.png" alt="LaxmiInfra" />
											<div className="share">
												<Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" width={17} height={18} viewBox="0 0 17 18" fill="none">
													<path d="M14.1333 12.7229C13.4578 12.7229 12.8533 12.994 12.3911 13.4187L6.05332 9.66867C6.09777 9.46084 6.13332 9.25301 6.13332 9.03614C6.13332 8.81928 6.09777 8.61145 6.05332 8.40361L12.32 4.68976C12.8 5.14157 13.4311 5.42169 14.1333 5.42169C15.6089 5.42169 16.8 4.21084 16.8 2.71084C16.8 1.21084 15.6089 0 14.1333 0C12.6578 0 11.4667 1.21084 11.4667 2.71084C11.4667 2.92771 11.5022 3.13554 11.5467 3.34337L5.27999 7.05723C4.79999 6.60542 4.16888 6.3253 3.46665 6.3253C1.9911 6.3253 0.799988 7.53614 0.799988 9.03614C0.799988 10.5361 1.9911 11.747 3.46665 11.747C4.16888 11.747 4.79999 11.4669 5.27999 11.0151L11.6089 14.7741C11.5644 14.9639 11.5378 15.1627 11.5378 15.3614C11.5378 16.8163 12.7022 18 14.1333 18C15.5644 18 16.7289 16.8163 16.7289 15.3614C16.7289 13.9066 15.5644 12.7229 14.1333 12.7229Z" fill="white" />
												</svg></Link>
								...
								<div className="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-duration={1200}>
									<div className="team-widget-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/team/team-img4.png" alt="LaxmiInfra" />
											<div className="share">
												<Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" width={17} height={18} viewBox="0 0 17 18" fill="none">
													<path d="M14.1333 12.7229C13.4578 12.7229 12.8533 12.994 12.3911 13.4187L6.05332 9.66867C6.09777 9.46084 6.13332 9.25301 6.13332 9.03614C6.13332 8.81928 6.09777 8.61145 6.05332 8.40361L12.32 4.68976C12.8 5.14157 13.4311 5.42169 14.1333 5.42169C15.6089 5.42169 16.8 4.21084 16.8 2.71084C16.8 1.21084 15.6089 0 14.1333 0C12.6578 0 11.4667 1.21084 11.4667 2.71084C11.4667 2.92771 11.5022 3.13554 11.5467 3.34337L5.27999 7.05723C4.79999 6.60542 4.16888 6.3253 3.46665 6.3253C1.9911 6.3253 0.799988 7.53614 0.799988 9.03614C0.799988 10.5361 1.9911 11.747 3.46665 11.747C4.16888 11.747 4.79999 11.4669 5.27999 11.0151L11.6089 14.7741C11.5644 14.9639 11.5378 15.1627 11.5378 15.3614C11.5378 16.8163 12.7022 18 14.1333 18C15.5644 18 16.7289 16.8163 16.7289 15.3614C16.7289 13.9066 15.5644 12.7229 14.1333 12.7229Z" fill="white" />
												</svg></Link>
										...
										<div className="row align-items-center">
											<div className="col-lg-5">
												<Slider {...settings2} className="images-area2 slider2">
													<div className="img1 image-anime">
														<img src="/assets/img/all-images/testimonial/testimonial-img1.png" alt="LaxmiInfra" />
													</div>
													<div className="img1 image-anime">
														<img src="/assets/img/all-images/testimonial/testimonial-img1.png" alt="LaxmiInfra" />
													</div>
											...
											<div className="col-lg-7">
												<Slider {...settings1} className="testimonial-slider-area slider1">
													<div className="testimonial-box">
														<img src="/assets/img/icons/quoto-icon1.svg" alt="LaxmiInfra" />
														<div className="space16" />
														<p>"When I decided to sell my home, I was overwhelmed with where to start.
															LaxmiInfra stepped in with a clear plan, professional marketing, constant
															communicate. Within two weeks, my house was sold above asking.”</p>
														<div className="space32" />
														<div className="test-images">
															<div className="auhtor-area">
																<div className="img1">
																	<img src="/assets/img/all-images/testimonial/testimonial-img2.png" alt="LaxmiInfra" />
																</div>
																<div className="text">
															...
															<img src="/assets/img/elements/brand1.png" alt="LaxmiInfra" className="brand1" />
														</div>
													</div>
													<div className="testimonial-box">
														<img src="/assets/img/icons/quoto-icon1.svg" alt="LaxmiInfra" />
										...
										<div className="row align-items-center">
											<div className="col-lg-5">
												<div className="cta-header">
													<h2 className="text-anime-style-3">Step Into Your Dream Home with LaxmiInfra</h2>
													<div className="space16" />
													<p data-aos="fade-left" data-aos-duration={1000}>At LaxmiInfra, we believe your next
