												...
												<div className="images-area2">
													...
													<div className="content-area2">
														<div className="content">
															...
															<ul>
																<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="housebox" />x20 <span> | </span></Link></li>
																<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="housebox" />x30 <span> | </span></Link></li>
																<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="housebox" />1200 sq</Link></li>
															</ul>
														</div>
														<Link href="/#" className="price">$8,500</Link>
													</div>
												</div>
											</div>
										</div>
											...
											<div className="details-siderbar">
														...
														<div className="list-area">
															<div className="list">
																...
																<ul>
																	...
																	</svg> Los Angeles City, CA, USA</Link></li>
																</ul>
															</div>
															<ul className="share">
																<li><Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
												...
												<div className="download-box">
													...
													<div className="download">
														<Link href="/#"><span><img src="/assets/img/icons/pdf1.svg" alt="housebox" /></span>Villa Document. pdf <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M13 10H18L12 16L6 10H11V3H13V10ZM4 19H20V12H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V12H4V19Z" />
														</svg></Link>
														<Link href="/#" className="m-0"><span><img src="/assets/img/icons/pdf2.svg" alt="housebox" /></span>Villa Document. pdf <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M13 10H18L12 16L6 10H11V3H13V10ZM4 19H20V12H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V12H4V19Z" />
														</svg></Link>
													</div>
												</div>
												...
												<div className="rotate-images">
													...
													<Link href="/#"><img src="/assets/img/icons/rotate.svg" alt="housebox" /></Link>
												</div>
												<div className="space60" />
												<h3>Map Locations</h3>
												<div className="space32" />
														...
														<div className="accordion-item">
															<h2 className="accordion-header">
																<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
																	...
																	<span className="list">
																		<span><img src="/assets/img/icons/bed1.svg" alt="housebox" />x20</span>
																		<span><img src="/assets/img/icons/bath1.svg" alt="housebox" />x30</span>
																		<span><img src="/assets/img/icons/sqare1.svg" alt="housebox" />1200 sq</span>
																	</span>
																</button>
															</h2>
												...
												<div className="comments-boxarea">
													<div className="comments-boxes">
														<div className="comments-auhtor-box">
															...
															<div className="content">
																<Link href="/#" className="date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
																	<path d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM8 13V15H6V13H8ZM13 13V15H11V13H13ZM18 13V15H16V13H18ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z" />
																</svg> 8 December 2024</Link>
																<Link href="/team" className="name">Alex Robertson</Link>
															</div>
														</div>
														<Link href="/#" className="reply"><i className="fa-solid fa-reply" /> Reply</Link>
													</div>
													<div className="space16" />
													...
													<div className="comments-boxes">
														<div className="comments-auhtor-box">
															...
															<div className="content">
																<Link href="/#" className="date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
																	<path d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM8 13V15H6V13H8ZM13 13V15H11V13H13ZM18 13V15H16V13H18ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z" />
																</svg> 12 May 2024</Link>
																<Link href="/team" className="name">Theo Hernandez</Link>
															</div>
														</div>
														<Link href="/#" className="reply"><i className="fa-solid fa-reply" /> Reply</Link>
													</div>
												...
												<div className="contact-boxarea">
													...
													<div className="row">
														...
														<div className="col-lg-12">
															...
															<div className="input-area">
																<button type="submit" className="theme-btn1">Find Your Dream Home <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
													...
													<div className="tab-content" id="pills-tabContent">
															...
															<div className="row">
																...
																<div className="col-lg-12">
																	<div className="btn-area1">
																		<Link href="/contact" className="theme-btn1">Find Your Dream Property <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																			<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
																		</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																			<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
																		</svg></span></Link>
														...
														<div className="tab-pane fade" id="pills-profile1" role="tabpanel" aria-labelledby="pills-profile1-tab" tabIndex={0}>
															...
															<div className="row">
																...
																<div className="col-lg-12">
																	<div className="btn-area1">
																		<Link href="/" className="theme-btn1">Find Your Dream Property <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																			<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
																		</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
																			<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
																		</svg></span></Link>
									...
									<Swiper {...swiperOptions1} className="single-slider-area owl-carousel">
										<SwiperSlide className="property-boxarea">
											...
											<div className="category-list">
												<ul>
													<li><Link href="/property-details-v1">Featured</Link></li>
													<li><Link href="/property-details-v1">For Sale</Link></li>
												</ul>
											</div>
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="housebox" />x12</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="housebox" />x16</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="housebox" />1200 sq</Link></li>
												</ul>
										...
										<SwiperSlide className="property-boxarea">
											...
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="housebox" />x23</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="housebox" />x34</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="housebox" />1200 sq</Link></li>
												</ul>
												<div className="btn-area">
													<Link href="/#" className="nm-btn">$820,000</Link>
										...
										<div className="row align-items-center">
											...
											<div className="col-lg-5" data-aos="zoom-in" data-aos-duration={1000}>
												<div className="btn-area1 text-center">
													<Link href="/contact" className="theme-btn1">Find Your Dream Home <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
														<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
													</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
														<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
													</svg></span></Link>
