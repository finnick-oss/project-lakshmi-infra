							...
							<div className="row">
								...
								<div className="col-lg-12">
									<div className="property-main-boxarea">
										...
										<div className="box-uploadfile text-center">
											<div className="uploadfile">
												...
												<p className="file-name fw-5">or drag photos here <br />
											...
											<div className="box-img-upload">
												<div className="item-upload file-delete">
													...
													<span className="remove-file"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
											...
											<div className="col-lg-4 col-md-6">
												...
												<div className="input-area">
													...
													<div className="nice-select" tabIndex={0}>
														...
														<ul className="list">
															<li data-value={1} className="option">USA</li>
															<li data-value={2} className="option selected">Australia</li>
															<li data-value={1} className="option">England</li>
															<li data-value={1} className="option">Portugal</li>
															<li data-value={1} className="option">California</li>
															<li data-value={1} className="option">Inter Milan</li>
															<li data-value={1} className="option">Liverpool</li>
														</ul>
													</div>
												</div>
											</div>
											<div className="col-lg-4 col-md-6">
												...
												<div className="input-area">
													...
													<div className="nice-select" tabIndex={0}>
														...
														<ul className="list">
															<li data-value={1} className="option">Texas</li>
															<li data-value={2} className="option selected">New York</li>
														</ul>
													</div>
												</div>
											</div>
											...
											<div className="col-lg-4 col-md-6">
												...
												<div className="input-area">
													...
													<div className="nice-select" tabIndex={0}>
														...
														<ul className="list">
															<li data-value={1} className="option">Villa</li>
															<li data-value={2} className="option selected">Studio</li>
															<li data-value={1} className="option">Park</li>
														</ul>
													</div>
												</div>
											</div>
											<div className="col-lg-4 col-md-6">
												...
												<div className="input-area">
													...
													<div className="nice-select" tabIndex={0}>
														<span className="current">Choose</span>
														<ul className="list">
															<li data-value={1} className="option">For Rent</li>
															<li data-value={2} className="option selected">For Sale</li>
														</ul>
													</div>
												</div>
											</div>
											<div className="col-lg-4 col-md-6">
												...
												<div className="input-area">
													...
													<div className="nice-select" tabIndex={0}>
														<span className="current">Choose</span>
														<ul className="list">
															<li data-value={1} className="option">New Listing</li>
															<li data-value={2} className="option selected">Open House</li>
														</ul>
													</div>
												</div>
											</div>
									...
									<div className="btn-area1 text-center">
										<Link href="/#" className="theme-btn1">Add Property <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
										...
										<Link href="/#" className="theme-btn1 btn2">Save And Preview <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
											<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
										</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
											<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
										</svg></span></Link>
