										...
										<div className="row">
											...
											<div className="col-lg-3 col-md-6">
												...
												<div className="input-area">
													<h5>Email Address*</h5>
													<div className="space16" />
													<input type="email" placeholder="LaxmiInfra@gmail.com" />
												</div>
											</div>
											<div className="col-lg-3 col-md-6">
												<div className="space28" />
										...
										<div className="row align-items-center">
											<div className="col-lg-5">
												<div className="cta-header">
													...
													<div className="space16" />
													<p data-aos="fade-left" data-aos-duration={1000}>At LaxmiInfra, we believe your next home is more than just a place – it’s where your future begins you’re buy.</p>
												</div>
											</div>
