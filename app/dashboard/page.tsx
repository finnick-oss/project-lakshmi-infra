										...
										<div className="row">
											...
											<div className="col-lg-4 col-md-6">
												<div className="input-area">
													<div className="nice-select" tabIndex={0}>
														...
														<ul className="list">
															<li data-value={1} className="option">Today</li>
															<li data-value={2} className="option selected">Yesterday</li>
														</ul>
													</div>
												</div>
											</div>
											...
											<div className="table-container">
												...
												<div className="table-row">
													<div className="listing">
														...
														<div className="details">
															...
															<p>
																<span><img src="/assets/img/icons/bed1.svg" alt="housebox" /> x2</span>
																<span><img src="/assets/img/icons/bath1.svg" alt="housebox" /> x2</span>
																<span><img src="/assets/img/icons/sqare1.svg" alt="housebox" /> 1200
																	sq</span>
															</p>
													...
													<div className="status">
														<Link href="/#" className="status-badge approved">Approved</Link>
													</div>
													<div className="actions">
														<button className="edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
														...
														<button className="sold"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
														...
														<button className="delete"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
												...
												<div className="table-row">
													...
													<div className="status">
														<Link href="/#" className="status-badge pending">Pending</Link>
													</div>
													<div className="actions">
														<button className="edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M6.41421 15.89L16.5563 5.74785L15.1421 4.33363L5 14.4758V15.89H6.41421ZM7.24264 17.89H3V13.6473L14.435 2.21231C14.8256 1.82179 15.4587 1.82179 15.8492 2.21231L18.6777 5.04074C19.0682 5.43126 19.0682 6.06443 18.6777 6.45495L7.24264 17.89ZM3 19.89H21V21.89H3V19.89Z">
												...
												<div className="table-row">
													...
													<div className="status">
														<Link href="/#" className="status-badge sold">Sold</Link>
													</div>
													<div className="actions">
														<button className="edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M6.41421 15.89L16.5563 5.74785L15.1421 4.33363L5 14.4758V15.89H6.41421ZM7.24264 17.89H3V13.6473L14.435 2.21231C14.8256 1.82179 15.4587 1.82179 15.8492 2.21231L18.6777 5.04074C19.0682 5.43126 19.0682 6.06443 18.6777 6.45495L7.24264 17.89ZM3 19.89H21V21.89H3V19.89Z">
										...
										<div className="dashboard-info-sider">
											...
											<div className="message-boxarea">
												...
												<div className="conatent-area">
													...
													<p>We're excited to help you find the perfect neighborhood and home for your family
														Let us know how.</p>
												</div>
											</div>
											<div className="message-boxarea">
												...
												<div className="conatent-area">
													...
													<div className="space14" />
													<p>Thank you for reaching out! We’re here to guiding you every step of the way in
														finding the idea home.</p>
												</div>
											</div>
											<div className="message-boxarea" style={{ borderBottom: 'none', padding: 0 }}>
												...
												<div className="conatent-area">
													...
													<div className="space14" />
													<p>Finding the perfect place to call home is a journey worth taking, Explore our
														listings, resources.</p>
												</div>
											</div>
										</div>
										<div className="space30" />
										<div className="dashboard-info-sider">
											...
											<div className="message-boxarea">
												...
												<div className="conatent-area">
													...
													<div className="space14" />
													<p>We hope your home search is the going smoothly! If you have any question need
														more information.</p>
													<ul>
