							...
							<div className="row">
								<div className="col-lg-12">
									<div className="hero-header-area text-center">
										...
										</svg> Tools <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
												<path d="M13.1717 12.0007L8.22192 7.05093L9.63614 5.63672L16.0001 12.0007L9.63614 18.3646L8.22192 16.9504L13.1717 12.0007Z" />
											</svg> Loan Caculator </Link>
										...
										<div className="col-lg-6">
											<div className="contact-form-area">
												...
												<div className="row">
													...
													<div className="col-lg-12">
														<div className="input-area">
															<button type="submit" className="theme-btn1">Caculate Now <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
										...
										<div className="col-lg-6">
											<div className="contact-form-area mb-4">
												...
												<div className="d-flex align-items-center gap-4">
													<Link href="/contact" className="theme-btn1">Download PDF <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
														<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
													</svg></span><span className="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
														<path d="M12 13H4V11H12V4L20 12L12 20V13Z" />
													</svg></span></Link>
													<Link href="/https://www.google.com/maps/@24.0098057,88.9892437,15z?entry=ttu" className="link-big" target="_blank">Contact Us</Link>
												</div>
											</div>
													...
													<table className="table table-striped">
														...
														<tbody>
															...
															<tr>
																<th scope="row" />
																<td>Total</td>
																<td><span className="fw-semibold">900 USD</span></td>
															</tr>
														</tbody>
													</table>
												</div>
