							...
							<div className="row">
								<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={800}>
									<div className="project-featured-box">
										...
										<Link href="/property-details-v1" className="head">Buying A Home</Link>
										...
										<div className="btn-area1">
											<Link href="/contact" className="theme-btn1">Buy A Property <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
								...
								<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={1000}>
									<div className="project-featured-box">
										...
										<div className="space40" />
										<Link href="/property-details-v1" className="head">Sell A Home</Link>
										<div className="space16" />
								...
								<div className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration={1200}>
									<div className="project-featured-box">
										...
										<div className="space40" />
										<Link href="/property-details-v1" className="head">Rent A Home</Link>
										<div className="space16" />
